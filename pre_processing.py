...
"""
        ...
        final = ast.literal_eval(raw_output)
        img = product_name+".png"
        prompt= product_description
        generate_image(("generate a image based on the description"+prompt)[:200],img)
        final["image url"] = img
        return final
...
print(refine_product_json({"product name": "Smartphone", "description": "A high-end smartphone with a 6.5-inch display, 128GB storage, and a powerful camera."}))